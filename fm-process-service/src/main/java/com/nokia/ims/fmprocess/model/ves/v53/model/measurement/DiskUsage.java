...
public class DiskUsage {
    ...
    public String toString() {
        return "DiskUsage{" +
                ...
                ", diskIoTimeAvg=" + diskIoTimeAvg +
                ", diskIoTimeLast=" + diskIoTimeLast +
                ", diskIoTimeMax=" + diskIoTimeMax +
                ", diskIoTimeMin=" + diskIoTimeMin +
                ", diskMergedReadAvg=" + diskMergedReadAvg +
                ", diskMergedReadLast=" + diskMergedReadLast +
                ", diskMergedReadMax=" + diskMergedReadMax +
                ", diskMergedReadMin=" + diskMergedReadMin +
                ", diskMergedWriteAvg=" + diskMergedWriteAvg +
                ", diskMergedWriteLast=" + diskMergedWriteLast +
                ", diskMergedWriteMax=" + diskMergedWriteMax +
                ", diskMergedWriteMin=" + diskMergedWriteMin +
                ", diskOctetsReadAvg=" + diskOctetsReadAvg +
                ", diskOctetsReadLast=" + diskOctetsReadLast +
                ", diskOctetsReadMax=" + diskOctetsReadMax +
                ", diskOctetsReadMin=" + diskOctetsReadMin +
                ", diskOctetsWriteAvg=" + diskOctetsWriteAvg +
                ", diskOctetsWriteLast=" + diskOctetsWriteLast +
                ", diskOctetsWriteMax=" + diskOctetsWriteMax +
                ", diskOctetsWriteMin=" + diskOctetsWriteMin +
                ", diskOpsReadAvg=" + diskOpsReadAvg +
                ", diskOpsReadLast=" + diskOpsReadLast +
                ", diskOpsReadMax=" + diskOpsReadMax +
                ", diskOpsReadMin=" + diskOpsReadMin +
                ", diskOpsWriteAvg=" + diskOpsWriteAvg +
                ", diskOpsWriteLast=" + diskOpsWriteLast +
                ", diskOpsWriteMax=" + diskOpsWriteMax +
                ", diskOpsWriteMin=" + diskOpsWriteMin +
                ", diskPendingOperationsAvg=" + diskPendingOperationsAvg +
                ", diskPendingOperationsLast=" + diskPendingOperationsLast +
                ", diskPendingOperationsMax=" + diskPendingOperationsMax +
                ", diskPendingOperationsMin=" + diskPendingOperationsMin +
                ", diskTimeReadAvg=" + diskTimeReadAvg +
                ", diskTimeReadLast=" + diskTimeReadLast +
                ", diskTimeReadMax=" + diskTimeReadMax +
                ", diskTimeReadMin=" + diskTimeReadMin +
                ", diskTimeWriteAvg=" + diskTimeWriteAvg +
                ", diskTimeWriteLast=" + diskTimeWriteLast +
                ", diskTimeWriteMax=" + diskTimeWriteMax +
                ", diskTimeWriteMin=" + diskTimeWriteMin +
                '}';
    }
}
