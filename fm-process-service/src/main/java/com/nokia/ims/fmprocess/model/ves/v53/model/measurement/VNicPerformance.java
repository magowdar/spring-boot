...
public class VNicPerformance {
    ...
    public String toString() {
        return "VNicPerformance{" +
                "receivedBroadcastPacketsAccumulated=" + receivedBroadcastPacketsAccumulated +
                ", receivedBroadcastPacketsDelta=" + receivedBroadcastPacketsDelta +
                ", receivedDiscardedPacketsAccumulated=" + receivedDiscardedPacketsAccumulated +
                ", receivedDiscardedPacketsDelta=" + receivedDiscardedPacketsDelta +
                ", receivedErrorPacketsAccumulated=" + receivedErrorPacketsAccumulated +
                ", receivedErrorPacketsDelta=" + receivedErrorPacketsDelta +
                ", receivedMulticastPacketsAccumulated=" + receivedMulticastPacketsAccumulated +
                ", receivedMulticastPacketsDelta=" + receivedMulticastPacketsDelta +
                ", receivedOctetsAccumulated=" + receivedOctetsAccumulated +
                ", receivedOctetsDelta=" + receivedOctetsDelta +
                ", receivedTotalPacketsAccumulated=" + receivedTotalPacketsAccumulated +
                ", receivedTotalPacketsDelta=" + receivedTotalPacketsDelta +
                ", receivedUnicastPacketsAccumulated=" + receivedUnicastPacketsAccumulated +
                ", receivedUnicastPacketsDelta=" + receivedUnicastPacketsDelta +
                ", transmittedBroadcastPacketsAccumulated=" + transmittedBroadcastPacketsAccumulated +
                ", transmittedBroadcastPacketsDelta=" + transmittedBroadcastPacketsDelta +
                ", transmittedDiscardedPacketsAccumulated=" + transmittedDiscardedPacketsAccumulated +
                ", transmittedDiscardedPacketsDelta=" + transmittedDiscardedPacketsDelta +
                ", transmittedErrorPacketsAccumulated=" + transmittedErrorPacketsAccumulated +
                ", transmittedErrorPacketsDelta=" + transmittedErrorPacketsDelta +
                ", transmittedMulticastPacketsAccumulated=" + transmittedMulticastPacketsAccumulated +
                ", transmittedMulticastPacketsDelta=" + transmittedMulticastPacketsDelta +
                ", transmittedOctetsAccumulated=" + transmittedOctetsAccumulated +
                ", transmittedOctetsDelta=" + transmittedOctetsDelta +
                ", transmittedTotalPacketsAccumulated=" + transmittedTotalPacketsAccumulated +
                ", transmittedTotalPacketsDelta=" + transmittedTotalPacketsDelta +
                ", transmittedUnicastPacketsAccumulated=" + transmittedUnicastPacketsAccumulated +
                ", transmittedUnicastPacketsDelta=" + transmittedUnicastPacketsDelta +
                ", valuesAreSuspect='" + valuesAreSuspect + '\'' +
                ", vNicIdentifier='" + vNicIdentifier + '\'' +
                '}';
    }
}
