...
/*This Thread subclass is used to send Esymac alarm objects to esymac for major alarms*/
public class MajorEsymacOutputHandler extends Thread{
	static Logger logger = LogManager.getLogger(MajorEsymacOutputHandler.class.getName());

	public MajorEsymacOutputHandler() {
		try {
