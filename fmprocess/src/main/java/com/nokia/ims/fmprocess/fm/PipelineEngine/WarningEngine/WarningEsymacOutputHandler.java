...
/*This Thread subclass is used to send Esymac alarm objects to esymac for warning alarms*/
public class WarningEsymacOutputHandler extends Thread{
	static Logger logger = LogManager.getLogger(WarningEsymacOutputHandler.class.getName());

	public WarningEsymacOutputHandler() {
		try {
			SetupEsymac.setEsymacManager();
	...
	public void sendData() {/*
		try {
			logger.info("Alarm just before sending to esymac is " + esymacAlarm.getNoiAlarmEventTime());
