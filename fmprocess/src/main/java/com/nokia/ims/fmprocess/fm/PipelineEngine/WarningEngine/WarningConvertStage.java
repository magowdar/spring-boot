...
/*This stage is used to convert an FmEvent Object to Esymac alarm for warning alarms*/
public class WarningConvertStage extends PipelineStage {

	static Logger logger = LogManager.getLogger(WarningConvertStage.class.getName());

	private WarningEsymacOutputHandler outPutRef;

	public WarningConvertStage(WarningEsymacOutputHandler outPutRef) {
