...
/*This stage is used to convert an FmEvent Object to Esymac alarm for major alarms*/
public class MajorConvertStage extends PipelineStage {

	static Logger logger = LogManager.getLogger(MajorConvertStage.class.getName());

	private MajorEsymacOutputHandler outPutRef;

	public MajorConvertStage(MajorEsymacOutputHandler outPutRef) {
