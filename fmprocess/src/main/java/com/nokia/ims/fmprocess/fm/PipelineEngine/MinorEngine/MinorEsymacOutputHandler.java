...
/*This Thread subclass is used to send Esymac alarm objects to esymac for minor alarms*/
public class MinorEsymacOutputHandler extends Thread{
	static Logger logger = LogManager.getLogger(MinorEsymacOutputHandler.class.getName());

	public MinorEsymacOutputHandler() {
		try {
